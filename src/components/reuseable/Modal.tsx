...
export default function Modal({ isModal, handleModal, children }: ModalInterface) {
    ...
    return (
        <div className="z-10 flex justify-center items-start absolute top-0 left-0 h-screen w-screen bg-zinc-700 opacity-90">
            <div className=" shadow-sm shadow-red-200 p-4 relative bg-zinc-800 mt-12 min-h-24 min-w-24 rounded-md">
